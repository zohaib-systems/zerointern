...
export default function WelcomeScreen({ user, onStart, onSkip }: { user: OnboardingUser; onStart: () => void; onSkip: () => void }) {
  ...
  return <section className={`${styles.card} ${styles.welcome}`}>
    ...
    <p className={styles.muted}>Answer 3 quick questions · About 30–45 seconds</p>
