...
export default function SignInPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-900 px-6 text-white">
      <section className="w-full max-w-md rounded-2xl border border-slate-600 bg-slate-800 p-8 shadow-2xl">
        ...
        <div className="mt-8 space-y-4">
          <GoogleSignInButton />
          <Link href="/explore" className="block text-center text-sm text-slate-300 hover:text-white">Browse tracks without signing in</Link>
        </div>
      </section>
    </main>
  );
