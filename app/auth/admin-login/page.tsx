...
export default function AdminLoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-900 px-6 text-white">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-2xl border border-slate-600 bg-slate-800 p-8 shadow-2xl">
        ...
        <p className="mt-2 text-slate-300">Use the administrator password to continue.</p>
        <label htmlFor="password" className="mt-8 block text-sm font-medium text-slate-300">Password</label>
        <input
          id="password"
          type="password"
          value={password}
          ...
          required
          className="mt-2 w-full rounded-xl border border-slate-600 bg-slate-900 px-4 py-3 outline-none focus:border-cyan-400"
        />
